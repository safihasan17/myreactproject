    ...
    return(
      <>
        ...
        <div className="logo-area">
          <NavLink to="index.html" className="d-inline-flex">
            <img
        ...
        <ul className="nav flex-column">
          ...
          <li>
            <NavLink className="nav-link" to="create-product.html">
          ...
          <li>
            <NavLink className="nav-link" to="404-error.html">
              <i className="ti ti-alert-circle"></i>
              <span className="nav-text">404 Error</span>
            </NavLink>
          </li>
          <li>
          ...
          <li>
            <NavLink className="nav-link" to="signin.html">
